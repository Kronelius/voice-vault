  ...
  pipeline: [
    {
      ...
      steps: [
        ...
        { id: 'wf-03', icon: '🎙️', label: 'Build Voice Profile', sub: 'Voice Vault generates a tailored writing voice — no user input needed',
          detail: 'The Voice Vault (your internal tool) creates the voice profile before the customer ever touches the system. You analyze brand voice, existing content, and style preferences to craft a custom voice profile — tone spectrum, vocabulary patterns, sentence structure, signature moves, audience adaptation. The customer pays for premium, tailored writing quality out of the box. The voice profile is loaded as context for all content generation.',
          actions: ['Analyze brand voice & existing content (internal)', 'Craft voice profile via Voice Vault tools', 'Define tone spectrum, signature moves, reading level targets', 'Store reusable voice profile + system prompt', 'Load profile as context for all generation tasks'],
          apis: ['Anthropic Claude API (voice analysis)', 'Voice Vault internal tools (chunks, samples, profile editor)'],
        },
      ],
    },
    {
